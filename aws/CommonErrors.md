...
some steps/notes from the [AWS HOWTO](HOWTO.md)/[README](../../../Downloads/tr-05-gigamon-threatinsight-develop/README.md). So this
...
`s3_bucket` setting in the [Zappa Settings](../../../Downloads/tr-05-gigamon-threatinsight-develop/zappa_settings.json) to be a
